...
class SettingsScreen(private val root: View, private val host: ScreenHost) {
    ...
    private val pitchLaneCheck: CheckBox = root.findViewById(R.id.chk_pitch_lane)
    ...
    init {
        ...
        pitchLaneCheck.isChecked = settings.showPitchLane
        setupMapSpinners()
    ...
    private fun save() {
        ...
        settings.showPitchLane = pitchLaneCheck.isChecked
